...
const DoctorDashboard = () => {
  ...
  const [formInput, setFormInput] = useState({
    ...
    maxPatients: "5", fee: "500", mode: "In-Person" // Default values
  });
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-50">
            ...
            {/* ROW 2: MODE & FEE (Attractive Styling) */}
  ...
  return (
    <div className="flex min-h-screen bg-[#F8FAFC] font-sans text-left relative">
      ...
      <div className="flex-1 flex flex-col transition-all duration-300 overflow-hidden h-screen text-left">
        ...
        <main className="p-10 overflow-y-auto bg-[#F8FAFC] flex-1 custom-scrollbar">{view === "dashboard" ? <DashboardHome /> : view === "appointments" ? <AppointmentManager /> : view === "patients" ? <PatientList /> : view === "schedule" ? <ScheduleManager /> : <div className="text-center p-20 text-slate-400 font-bold italic">Coming soon.</div>}</main>
      </div>
